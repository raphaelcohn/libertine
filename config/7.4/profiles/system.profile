...
{
	cat <<-EOF
		tar	autoconf	2.69	"$GNU"/autoconf/autoconf-2.69.tar.xz	50f97f4159805e374639a73e2636f22e	xz	autoconf-2.69.tar.xz	autoconf-2.69
		tar	automake	1.14	"$GNU"/automake/automake-1.14.tar.xz	cb3fba6d631cddf12e230fd0cc1890df	xz	automake-1.14.tar.xz	automake-1.14
		...
		tar	bison	3.0	"$GNU"/bison/bison-3.0.tar.xz	a2624994561aa69f056c904c1ccb2880	xz	bison-3.0.tar.xz	bison-3.0
		tar	flex	2.5.37	"$SOURCEFORGE"/"$ourSourcePackageName"/flex-2.5.37.tar.bz2	c75940e1fc25108f2a7b3ef42abdae06	bzip2	flex-2.5.37.tar.bz2	flex-2.5.37
		tar	gdbm	1.10	"$GNU"/gdbm/gdbm-1.10.tar.gz	88770493c2559dc80b561293e39d3570	gzip	gdbm-1.10.tar.gz	gdbm-1.10
		tar	groff	1.22.2	"$GNU"/groff/groff-1.22.2.tar.gz	9f4cd592a5efc7e36481d8d8d8af6d16	gzip	groff-1.22.2.tar.gz	groff-1.22.2
		tar	grub	2.00	"$GNU"/grub/grub-2.00.tar.xz	a1043102fbc7bcedbf53e7ee3d17ab91	xz	grub-2.00.tar.xz	grub-2.00
		...
		tar	inetutils	1.9.1	"$GNU"/inetutils/inetutils-1.9.1.tar.gz	944f7196a2b3dba2d400e9088576000c	gzip	inetutils-1.9.1.tar.gz	inetutils-1.9.1
		...
		tar	libtool	2.4.2	"$GNU"/libtool/libtool-2.4.2.tar.gz	d2f3b7d4627e69e13514a40e72a24d50	gzip	libtool-2.4.2.tar.gz	libtool-2.4.2
		...
		tar	psmisc	22.20	"$SOURCEFORGE"/"$ourSourcePackageName"/psmisc-22.20.tar.gz	a25fc99a6dc7fa7ae6e4549be80b401f	gzip	psmisc-22.20.tar.gz	psmisc-22.20
		tar	readline	6.2	"$GNU"/readline/readline-6.2.tar.gz	67948acb2ca081f23359d0256e9a271c	gzip	readline-6.2.tar.gz	readline-6.2
		...
		patch	automake	1.14	"$PATCHES"/automake-1.14-test-1.patch	1bc501443baee55bca4d6552ed18a757		automake-1.14-test-1.patch	automake-1.14-test-1.patch
		patch	bash	4.2	"$PATCHES"/bash-4.2-fixes-12.patch	419f95c173596aea47a23d922598977a		bash-4.2-fixes-12.patch	bash-4.2-fixes-12.patch
		patch	bzip2	1.0.6	"$PATCHES"/bzip2-1.0.6-installPackage_docs-1.patch	6a5ac7e89b791aae556de0f745916f7f		bzip2-1.0.6-installPackage_docs-1.patch
		patch	coreutils	8.21	"$PATCHES"/coreutils-8.21-i18n-1.patch	ada0ea6e1c00c4b7e0d634f49827943e		coreutils-8.21-i18n-1.patch	coreutils-8.21-i18n-1.patch
		patch	kbd	2.0.0	"$PATCHES"/kbd-2.0.0-backspace-1.patch	f75cca16a38da6caa7d52151f7136895		kbd-2.0.0-backspace-1.patch	kbd-2.0.0-backspace-1.patch
		patch	make	3.82	"$PATCHES"/make-3.82-upstream_fixes-3.patch	95027ab5b53d01699845d9b7e1dc878d		make-3.82-upstream_fixes-3.patch
		patch	tar	1.26	"$PATCHES"/tar-1.26-manpage-1.patch	321f85ec32733b1a9399e788714a5156		tar-1.26-manpage-1.patch	tar-1.26-manpage-1.patch
		patch	readline	6.2	"$PATCHES"/readline-6.2-fixes-1.patch	3c185f7b76001d3d0af614f6f2cd5dfa		readline-6.2-fixes-1.patch	readline-6.2-fixes-1.patch
	EOF
}
