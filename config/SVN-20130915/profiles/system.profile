...
{
	cat <<-EOF
		tar	autoconf	2.69	"$mirror_gnu"/autoconf/autoconf-2.69.tar.xz	50f97f4159805e374639a73e2636f22e	xz	autoconf-2.69.tar.xz	autoconf-2.69
		...
		tar	inetutils	1.9.1	"$mirror_gnu"/inetutils/inetutils-1.9.1.tar.gz	944f7196a2b3dba2d400e9088576000c	gzip	inetutils-1.9.1.tar.gz	inetutils-1.9.1
		...
		tar	libtool	2.4.2	"$mirror_gnu"/libtool/libtool-2.4.2.tar.gz	d2f3b7d4627e69e13514a40e72a24d50	gzip	libtool-2.4.2.tar.gz	libtool-2.4.2
		...
		patch	automake	1.14	"$lfs_patches_mirror"/automake-1.14-test-1.patch	1bc501443baee55bca4d6552ed18a757		automake-1.14-test-1.patch	automake-1.14-test-1.patch
		patch	bash	4.2	"$lfs_patches_mirror"/bash-4.2-fixes-12.patch	419f95c173596aea47a23d922598977a		bash-4.2-fixes-12.patch	bash-4.2-fixes-12.patch
		patch	bzip2	1.0.6	"$lfs_patches_mirror"/bzip2-1.0.6-installPackage_docs-1.patch	6a5ac7e89b791aae556de0f745916f7f		bzip2-1.0.6-installPackage_docs-1.patch
		patch	coreutils	8.21	"$lfs_patches_mirror"/coreutils-8.21-i18n-1.patch	ada0ea6e1c00c4b7e0d634f49827943e		coreutils-8.21-i18n-1.patch	coreutils-8.21-i18n-1.patch
		patch	kbd	2.0.0	"$lfs_patches_mirror"/kbd-2.0.0-backspace-1.patch	f75cca16a38da6caa7d52151f7136895		kbd-2.0.0-backspace-1.patch	kbd-2.0.0-backspace-1.patch
		patch	make	3.82	"$lfs_patches_mirror"/make-3.82-upstream_fixes-3.patch	95027ab5b53d01699845d9b7e1dc878d		make-3.82-upstream_fixes-3.patch
		patch	tar	1.26	"$lfs_patches_mirror"/tar-1.26-manpage-1.patch	321f85ec32733b1a9399e788714a5156		tar-1.26-manpage-1.patch	tar-1.26-manpage-1.patch
		patch	readline	6.2	"$lfs_patches_mirror"/readline-6.2-fixes-1.patch	3c185f7b76001d3d0af614f6f2cd5dfa		readline-6.2-fixes-1.patch	readline-6.2-fixes-1.patch
	EOF
}
